...
<template>
  <div class="consult-fast-page">
    <cp-nav-bar
      title="极速问诊"
      right-text="问诊记录"
      @right-click="$router.push('/user/consult')"
    ></cp-nav-bar>
    <div class="fast-logo">
    ...
    <div class="fast-type">
      <router-link to="/consult/dep" class="item" @click="store.setIillnessType(1)">
      ...
      <router-link to="/consult/dep" class="item" @click="store.setIillnessType(0)">
